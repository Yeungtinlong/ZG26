...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp11(MBF.AoeState p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp12(MBF.AoeState p0, System.Collections.Generic.List<MBF.CharacterState> p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.GameObject __Gen_Delegate_Imp13(MBF.BulletState p0, System.Collections.Generic.List<UnityEngine.GameObject> p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.Vector3 __Gen_Delegate_Imp14(float p0, MBF.BulletState p1, UnityEngine.GameObject p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp15(MBF.BulletState p0, UnityEngine.GameObject p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public object __Gen_Delegate_Imp16(MBF.TimelineObj p0, object[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public bool __Gen_Delegate_Imp17(TheGame.LSummonConfig p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public float __Gen_Delegate_Imp18(int p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp19(MBF.DamageInfo p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp20(int p0, string p1, out Tutorial.CSCallLua.DClass p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XLuaTest.InvokeLua.ICalc __Gen_Delegate_Imp22(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp24(object p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Threading.Tasks.Task __Gen_Delegate_Imp39(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Threading.Tasks.Task<int> __Gen_Delegate_Imp40(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(MBF.AoeOnTick))
			{
			    return new MBF.AoeOnTick(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(MBF.AoeOnRemove))
			{
			    return new MBF.AoeOnRemove(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(MBF.AoeOnCreate))
			{
			    return new MBF.AoeOnCreate(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(MBF.AoeOnCharacterEnter))
			{
			    return new MBF.AoeOnCharacterEnter(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(MBF.AoeOnCharacterLeave))
			{
			    return new MBF.AoeOnCharacterLeave(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(MBF.BulletTargeting))
			{
			    return new MBF.BulletTargeting(__Gen_Delegate_Imp13);
			}
		
		    if (type == typeof(MBF.BulletTween))
			{
			    return new MBF.BulletTween(__Gen_Delegate_Imp14);
			}
		
		    if (type == typeof(MBF.BulletOnHit))
			{
			    return new MBF.BulletOnHit(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(MBF.TimelineEvent))
			{
			    return new MBF.TimelineEvent(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(TheGame.SummonCondition))
			{
			    return new TheGame.SummonCondition(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(TheGame.GM.MoveSpeedDelegate))
			{
			    return new TheGame.GM.MoveSpeedDelegate(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(TheGame.GM.SkillSpeedDelegate))
			{
			    return new TheGame.GM.SkillSpeedDelegate(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(TheGame.GM.RangeDelegate))
			{
			    return new TheGame.GM.RangeDelegate(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(TheGame.GM.DamageDelegate))
			{
			    return new TheGame.GM.DamageDelegate(__Gen_Delegate_Imp19);
			}
		
		    if (type == typeof(Tutorial.CSCallLua.FDelegate))
			{
			    return new Tutorial.CSCallLua.FDelegate(__Gen_Delegate_Imp20);
			}
		
		    if (type == typeof(Tutorial.CSCallLua.GetE))
			{
			    return new Tutorial.CSCallLua.GetE(__Gen_Delegate_Imp21);
			}
		
		    if (type == typeof(XLuaTest.InvokeLua.CalcNew))
			{
			    return new XLuaTest.InvokeLua.CalcNew(__Gen_Delegate_Imp22);
			}
